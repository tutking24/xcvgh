...
class GitLabProjectMilestoneTest(IGittTestCase):
    def setUp(self):
        ...
        self.milestone = GitLabProjectMilestone(
    ...
    def test_created_getter(self):
        self.assertEqual(self.milestone.created,
                         datetime.datetime(2018, 4, 25, 9, 11, 0, 29000))
    ...
    def test_updated_getter(self):
        ...
        self.assertEqual(self.milestone.updated.date(),
                         datetime.datetime(2018, 4, 26).date())
        self.milestone.description = None
    ...
    def test_due_date_setter(self):
        ...
        self.assertEqual(self.milestone.due_date,
                         datetime.datetime(2050, 4, 23, 0, 0))
    ...
    def test_start_date_setter(self):
        ...
        self.assertEqual(self.milestone.start_date,
                         datetime.datetime(2040, 4, 23, 0, 0))
