...
class TestTimeRecord(IGittTestCase):
    ...
    def setUp(self):
        ...
        self.time_subtracting_comment = GitLabComment(token,
                                     'gitmate-test-user/test', 42,
                                     CommentType.ISSUE, 88185697)
        self.time_adding_comment = GitLabComment(token,
                                     'gitmate-test-user/test', 42,
                                     CommentType.ISSUE, 88185691)
        self.time_reseting_comment = GitLabComment(token,
                                     'gitmate-test-user/test', 42,
                                     CommentType.ISSUE, 88178597)
